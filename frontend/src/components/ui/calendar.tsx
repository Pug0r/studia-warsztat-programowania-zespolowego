  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative rounded-md border border-slate-200 shadow-xs has-focus:border-slate-950 has-focus:ring-[3px] has-focus:ring-slate-950/50",
        ...
        disabled: cn("text-slate-500 opacity-50", defaultClassNames.disabled),
