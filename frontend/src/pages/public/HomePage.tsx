...
const STATS = [
  { value: '1,240+', label: 'Animals adopted since 2018', delta: '+12% vs last year' },
  { value: '86', label: 'In our care today', delta: '32 ready to adopt' },
  { value: '420', label: 'Active volunteers', delta: 'Orientation every month' },
...
const STAFF_PORTALS = [
  { role: 'Public', name: 'This site', hint: 'Adopt, donate, events', href: '#top', current: true as const },
  { role: 'Admin', name: 'Operations', hint: 'Users, settings, reports', href: '#admin', current: false as const },
  { role: 'Volunteer', name: 'My shifts', hint: 'Schedule & tasks', href: '#volunteer', current: false as const },
  { role: 'Coordinator', name: 'Teams', hint: 'Rosters & approvals', href: '#coordinator', current: false as const },
  { role: 'Veterinarian', name: 'Clinical', hint: 'Records & rounds', href: '#vet', current: false as const },
] as const;
    ...
    <section className="hp-hero" aria-labelledby="hero-heading">
      <div>
        ...
        <p className="hp-hero__lead">
          We match dogs, cats, and small animals with loving homes—supported by volunteers,
          coordinators, and our veterinary team.
        </p>
...
function EventsAndCalendar() {
  return (
    <section className="hp-section" id="events" aria-labelledby="events-heading">
      ...
      <div className="hp-events-layout">
        ...
        <div className="hp-calendar" id="calendar" aria-label="March 2026 calendar with event days highlighted">
...
function AdoptionHowItWorks() {
  return (
    <section className="hp-section" id="how-it-works" aria-labelledby="how-heading">
      <div className="hp-section__head">
        <div>
          <h2 id="how-heading">How adoption works</h2>
          <p>Transparent steps from first click to life at home—no guesswork.</p>
        </div>
      </div>
...
function StaffPortals() {
  return (
    <section className="hp-portals" id="portals" aria-labelledby="portals-heading">
      <div className="hp-portals__inner">
        <h2 id="portals-heading">Role-based workspaces</h2>
        <p>
          Staff and volunteers use dedicated panels (sidebar navigation, tables, and calendars)
          separate from this public site—tiles below map the future app shell.
        </p>
        <div className="hp-portals__grid">
          {STAFF_PORTALS.map((p) =>
            p.current ? (
              <div key={p.role} className="hp-portal-tile" style={{ cursor: 'default' }}>
  ...
  return (
    <footer className="hp-footer" id="donate">
      <div className="hp-footer__inner">
        <p>© {new Date().getFullYear()} Haven Shelter. A demo UI for coursework.</p>
